...
public class AffichageProduct extends BaseForm {
   ...
   public   ServiceProduct sproduct=new ServiceProduct();
    ...
    public AffichageProduct() throws IOException {

        
     //  f = new Form("Product List", BoxLayout.y());
...
//        rbs[0].setSelected(true);
        ...
        lse = new ServiceProduct().getListEvenements();
        int nb=0;
     ...
     ServiceAssociation sa=new ServiceAssociation();
        ...
        ArrayList<Product> v =sp.getListEvenements();
            ...
            for(int j=Associations.size()-1;j>=0;j--){
              ...
              System.out.println(lse.get(i).getId_Association());
...
System.out.println("ksklsls"+lse.get(Integer.parseInt(lip.getText())).getId_Product());
